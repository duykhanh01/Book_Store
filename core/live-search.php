    ...
    foreach ($products as $i => $product) {
        ...
        <div class='autocomplete-suggestion' onclick='window.location='/product-details.php?idsp=" . $product['pr_id'] . "''>
                ...
                <tr>
                    ...
                    <td class='d-block' style='vertical-align:top; line-height:18px; margin-left:10px;'><a class='suggest_link' href='product-details.php?idsp=" . $product['pr_id'] . "'>" . $product['pr_name'] . "</a><br><span class='text-danger mt-2'>Giá: " . number_format($product['pr_price'] - $product['pr_discount'], 0, ',', '.') . " VNĐ
        </span></td>
                </tr>
                </tbody>
                </table>  
